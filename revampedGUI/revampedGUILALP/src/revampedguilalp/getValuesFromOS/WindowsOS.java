...
public class WindowsOS {
	//This class is a wmi wrapper for java
	//we use it to return vga monitor
	//or execute wmi commands from java
	//would like to thank
	/**
	...
	public static final String CLASS_Win32_OSRecoveryConfiguration = "Win32_OSRecoveryConfiguraci�n";
