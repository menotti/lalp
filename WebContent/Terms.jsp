	...
	<div class='AllContent'>
		...
		<div class='PageContent'>
			...
			<div class='TermsContent'>
				...
				<p>By accessing this web site, you are agreeing to be bound by
					these web site Terms and Conditions of Use, all applicable laws and
				...
				<ol type="a">
					<li>Permission is granted to temporarily download one copy of
						the materials (information or software) on LALP's web site for
						...
						<ol type="i">
							...
							<li>attempt to decompile or reverse engineer any software
								contained on LALP's web site;</li>
					...
					<li>This license shall automatically terminate if you violate
						any of these restrictions and may be terminated by LALP at any
				...
				<ol type="a">
					<li>The materials on LALP's web site are provided "as is". LALP
						makes no warranties, expressed or implied, and hereby disclaims and
						negates all other warranties, including without limitation, implied
						warranties or conditions of merchantability, fitness for a
						particular purpose, or non-infringement of intellectual property or
						other violation of rights. Further, LALP does not warrant or make
				...
				<p>In no event shall LALP or its suppliers be liable for any
					damages (including, without limitation, damages for loss of data or
					profit, or due to business interruption,) arising out of the use or
					inability to use the materials on LALP's Internet site, even if LALP
					or a LALP authorized representative has been notified orally or in
				...
				<p>The materials appearing on LALP's web site could include
					technical, typographical, or photographic errors. LALP does not
					warrant that any of the materials on its web site are accurate,
					complete, or current. LALP may make changes to the materials
					contained on its web site at any time without notice. LALP does not,
					however, make any commitment to update the materials.</p>
	
				<h3>6. Links</h3>
	
				<p>LALP has not reviewed all of the sites linked to its Internet
					web site and is not responsible for the contents of any such linked
					site. The inclusion of any link does not imply endorsement by LALP
					of the site. Use of any such linked web site is at the user's own
					risk.</p>
	
				<h3>7. Site Terms of Use Modifications</h3>
	
				<p>LALP may revise these terms of use for its web site at any
				...
				<p>Any claim relating to LALP's web site shall be governed by the
					laws of Brazil without regard to its conflict of law provisions.</p>
	
				<p>General Terms and Conditions applicable to Use of a Web Site.
				</p>
				...
				<p>Your privacy is very important to us. Accordingly, we have
					...
					The following outlines our privacy policy.</p>
				...
				<ul>
					...
					<li>We will make readily available to customers information
						about our policies and practices relating to the management of
