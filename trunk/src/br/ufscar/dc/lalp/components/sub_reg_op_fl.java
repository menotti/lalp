 ...
 */
public class sub_reg_op_fl extends IComponent {
	private int initialValue = 0;
	public sub_reg_op_fl() {
		this(Parameters.getDefaultDataWidth());
	}
	public sub_reg_op_fl(int width) {
		super(width);
		Generic generic;
	...
	public sub_reg_op_fl(String name) {
		this();
		super.name = name;
	}
	public sub_reg_op_fl(String name, int width) {
		this(width);
		super.name = name;
	}
