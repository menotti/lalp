 ...
 * @deprecated
 */
public class adpcm_decoder_hw extends Design {
	public adpcm_decoder_hw() {
		super("adpcm_decoder");
		...
		module_for len = (module_for)this.addComponent(new module_for("for1", 10, DATASIZE, 3));
		// see the 2 counter version (_2c)
		// registers
		...
		delay_op lenDelayed = (delay_op)this.addComponent(new delay_op(10, 9));
		delay_op doneDelayed = (delay_op)this.addComponent(new delay_op(1, 9));
...
//		delay_op step9 = (delay_op)this.addComponent(new delay_op("step9", 1, 8));
		...
		try {
			...
			len.connectComponent("done", doneDelayed);
			len.connectComponent(lenDelayed);
...
//			len.connectComponent("step", step9);
			...
			step10.connectComponent(outdata, "we");
			...
			lenDelayed.connectComponent(outdata);
