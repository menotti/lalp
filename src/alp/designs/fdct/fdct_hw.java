 ...
 * @deprecated
 */
public class fdct_hw extends Design {
...
//		Parameters.setDefaultAddressWidth(19); // 2**19 = 524.288 
		...
		// cosine coefficients
//		const_op c0 = (const_op)this.addComponent(new const_op(0xB505, 32));
//		const_op c1 = (const_op)this.addComponent(new const_op(0x2C62, 32)); 
//		const_op c2 = (const_op)this.addComponent(new const_op(0x29CF, 32));                  
//		const_op c3 = (const_op)this.addComponent(new const_op(0x25A0, 32));
//		const_op c5 = (const_op)this.addComponent(new const_op(0x1924, 32));
//		const_op c6 = (const_op)this.addComponent(new const_op(0x1151, 32));      
//		const_op c7 = (const_op)this.addComponent(new const_op(0x08D4, 32));                  
		// registers
		...
		delay_op i1_delayed3 = (delay_op)this.addComponent(new delay_op("i1_delayed3", Parameters.getDefaultAddressWidth(), 3));
		delay_op i_1_delayed14 = (delay_op)this.addComponent(new delay_op("i_1_delayed14", Parameters.getDefaultAddressWidth(), 14));
		delay_op for_i_step2 = (delay_op)this.addComponent(new delay_op("for_i_step2", 1, 2));
		delay_op for_i_done_delayed18 = (delay_op)this.addComponent(new delay_op("for_i_done_delayed18", 1, 18));
		delay_op for_j_step1 = (delay_op)this.addComponent(new delay_op("for_j_step1", 1));
		delay_op for_j_step2 = (delay_op)this.addComponent(new delay_op("for_j_step2", 1));
		delay_op for_j_step3 = (delay_op)this.addComponent(new delay_op("for_j_step3", 1));
		delay_op for_j_step4 = (delay_op)this.addComponent(new delay_op("for_j_step4", 1));
		delay_op for_j_step5 = (delay_op)this.addComponent(new delay_op("for_j_step5", 1));
		delay_op for_j_step6 = (delay_op)this.addComponent(new delay_op("for_j_step6", 1));
		delay_op for_j_step7 = (delay_op)this.addComponent(new delay_op("for_j_step7", 1));
		delay_op for_j_step8 = (delay_op)this.addComponent(new delay_op("for_j_step8", 1));
		delay_op for_j_step9 = (delay_op)this.addComponent(new delay_op("for_j_step9", 1));
		delay_op for_j_step10 = (delay_op)this.addComponent(new delay_op("for_j_step10", 1));
		delay_op for_j_step11 = (delay_op)this.addComponent(new delay_op("for_j_step11", 1));
		delay_op for_j_step12 = (delay_op)this.addComponent(new delay_op("for_j_step12", 1));
		delay_op for_j_step13 = (delay_op)this.addComponent(new delay_op("for_j_step13", 1));
		delay_op for_j_step14 = (delay_op)this.addComponent(new delay_op("for_j_step14", 1));
		delay_op for_j_step15 = (delay_op)this.addComponent(new delay_op("for_j_step15", 1));
		delay_op for_j_step16 = (delay_op)this.addComponent(new delay_op("for_j_step16", 1));
		delay_op for_j_step17 = (delay_op)this.addComponent(new delay_op("for_j_step17", 1));
		delay_op for_j_step18 = (delay_op)this.addComponent(new delay_op("for_j_step18", 1));
		delay_op for_j_step19 = (delay_op)this.addComponent(new delay_op("for_j_step19", 1));
		delay_op for_j_step20 = (delay_op)this.addComponent(new delay_op("for_j_step20", 1));
		delay_op for_j_step21 = (delay_op)this.addComponent(new delay_op("for_j_step21", 1));
		delay_op for_j_step22 = (delay_op)this.addComponent(new delay_op("for_j_step22", 1));
		delay_op for_j_step23 = (delay_op)this.addComponent(new delay_op("for_j_step23", 1));
		...
		try {
			...
			for_i.connectComponent("done", for_i_done_delayed18);
			for_i.connectComponent("step", i1, "we");
			for_i.connectComponent("step", for_j, "clear");
			for_i.connectComponent("step", for_i_step2);
			for_i_step2.connectComponent(mj1);
			for_i_step2.connectComponent(for_i_step2Not);
			for_i_step2Not.connectComponent(j1);
			
			for_j.connectComponent("step", j1, "we");
			for_j.connectComponent("step", for_j_step1);
			for_j_step1.connectComponent(for_j_step1Not);
			for_j_step1.connectComponent(mi_1);
			for_j_step1.connectComponent(for_j_step2);
			for_j_step2.connectComponent(for_j_step3);
			for_j_step3.connectComponent(for_j_step4);
			for_j_step4.connectComponent(for_j_step5);
			for_j_step5.connectComponent(for_j_step6);
			for_j_step6.connectComponent(for_j_step7);
			for_j_step7.connectComponent(for_j_step8);
			for_j_step8.connectComponent(for_j_step9);
			for_j_step9.connectComponent(for_j_step10);
			for_j_step10.connectComponent(for_j_step11);
			for_j_step11.connectComponent(for_j_step12);
			for_j_step12.connectComponent(for_j_step13);
			for_j_step13.connectComponent(for_j_step14);
			for_j_step14.connectComponent(for_j_step15);
			for_j_step15.connectComponent(for_j_step16);
			for_j_step15.connectComponent(for_j_step16delay8);
			for_j_step16.connectComponent(for_j_step17);
			for_j_step17.connectComponent(for_j_step18);
			for_j_step18.connectComponent(for_j_step19);
			for_j_step19.connectComponent(for_j_step20);
			for_j_step20.connectComponent(for_j_step21);
			for_j_step21.connectComponent(for_j_step22);
			for_j_step22.connectComponent(for_j_step23);
			...
			i1.connectComponent(i1_delayed3);
			...
			i_1.connectComponent(i_1_delayed14);
			mj1.connectComponentI0I1(j1, i1_delayed3);
			...
			for_j_step3.connectComponent(f0, "we");
			for_j_step4.connectComponent(f1, "we");
			for_j_step5.connectComponent(f2, "we");
			for_j_step6.connectComponent(f3, "we");
			for_j_step7.connectComponent(f4, "we");
			for_j_step8.connectComponent(f5, "we");
			for_j_step9.connectComponent(f6, "we");
			for_j_step10.connectComponent(f7, "we");
			...
			s0aMultC0.connectComponentI0I1(s0a, this.addComponent(new const_op(0xB505, 32)));
			q0aMultC0.connectComponentI0I1(q0a, this.addComponent(new const_op(0xB505, 32)));
			...
			c6MultR1.connectComponentI0I1(this.addComponent(new const_op(0x1151, 32)), r1);
			c2MultR0.connectComponentI0I1(this.addComponent(new const_op(0x29CF, 32)), r0);
			c6MultR0.connectComponentI0I1(this.addComponent(new const_op(0x1151, 32)), r0);
			c2MultR1.connectComponentI0I1(this.addComponent(new const_op(0x29CF, 32)), r1);
			...
			c7MultQ1.connectComponentI0I1(this.addComponent(new const_op(0x08D4, 32)), Q_1);
			c1MultS1.connectComponentI0I1(this.addComponent(new const_op(0x2C62, 32)), S_1);
			c7MultS1.connectComponentI0I1(this.addComponent(new const_op(0x08D4, 32)), S_1);
			c1MultQ1.connectComponentI0I1(this.addComponent(new const_op(0x2C62, 32)), Q_1);
			c3MultQ0.connectComponentI0I1(this.addComponent(new const_op(0x25A0, 32)), Q_0);
			c5MultS0.connectComponentI0I1(this.addComponent(new const_op(0x1924, 32)), S_0);
			c3MultS0.connectComponentI0I1(this.addComponent(new const_op(0x25A0, 32)), S_0);
			c5MultQ0.connectComponentI0I1(this.addComponent(new const_op(0x1924, 32)), Q_0);
			...
			for_j_step14.connectComponent(F_0, "we");
			for_j_step14.connectComponent(F_1, "we");
			for_j_step14.connectComponent(F_2, "we");
			for_j_step14.connectComponent(F_3, "we");
			for_j_step14.connectComponent(F_4, "we");
			for_j_step14.connectComponent(F_5, "we");
			for_j_step14.connectComponent(F_6, "we");
			for_j_step14.connectComponent(F_7, "we");
			
			for_j_step16.connectComponent(mf, "Sel");
			for_j_step17.connectComponent(mf, "Sel");
			for_j_step18.connectComponent(mf, "Sel");
			for_j_step19.connectComponent(mf, "Sel");
			for_j_step20.connectComponent(mf, "Sel");
			for_j_step21.connectComponent(mf, "Sel");
			for_j_step22.connectComponent(mf, "Sel");
			...
			m_tmp.connectComponentI0I1(i_1_delayed14, xfor_i);
			m_tmp.connectComponent(dct_io_tmp);
/////////// second part of FDCT /////////////////////////////////////////////////////////////////////////////////////////////////////////////

			for_i_done_delayed18.connectComponent(xfor_i, "clk_en");
			for_i_done_delayed18.connectComponent(xi_1, "clk_en");
			...
			xs0aMultC0.connectComponentI0I1(xs0a, this.addComponent(new const_op(0xB505, 32)));
			xq0aMultC0.connectComponentI0I1(xq0a, this.addComponent(new const_op(0xB505, 32)));
			...
			xc6MultR1.connectComponentI0I1(this.addComponent(new const_op(0x1151, 32)), xr1);
			xc2MultR0.connectComponentI0I1(this.addComponent(new const_op(0x29CF, 32)), xr0);
			xc6MultR0.connectComponentI0I1(this.addComponent(new const_op(0x1151, 32)), xr0);
			xc2MultR1.connectComponentI0I1(this.addComponent(new const_op(0x29CF, 32)), xr1);
			...
			xc7MultQ1.connectComponentI0I1(this.addComponent(new const_op(0x08D4, 32)), xQ_1);
			xc1MultS1.connectComponentI0I1(this.addComponent(new const_op(0x2C62, 32)), xS_1);
			xc7MultS1.connectComponentI0I1(this.addComponent(new const_op(0x08D4, 32)), xS_1);
			xc1MultQ1.connectComponentI0I1(this.addComponent(new const_op(0x2C62, 32)), xQ_1);
			xc3MultQ0.connectComponentI0I1(this.addComponent(new const_op(0x25A0, 32)), xQ_0);
			xc5MultS0.connectComponentI0I1(this.addComponent(new const_op(0x1924, 32)), xS_0);
			xc3MultS0.connectComponentI0I1(this.addComponent(new const_op(0x25A0, 32)), xS_0);
			xc5MultQ0.connectComponentI0I1(this.addComponent(new const_op(0x1924, 32)), xQ_0);
