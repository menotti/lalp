...
/**
 * The unsigned GT (greater then) zero operation.
 * 
 ...
 */
public class gt_op extends IComponent {
	public gt_op() {
		this(Parameters.getDefaultDataWidth());
	}
	public gt_op(int width) {
		super(width);
		setSync(false);
		Generic generic;
	...
	public gt_op(String name) {
		this();
		super.name = name;
	}
	public gt_op(String name, int width) {
		this(width);
		super.name = name;
	}
