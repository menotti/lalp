...
/**
 * The unsigned NOT operation.
 * 
 * @author <a href="mailto:ricardomenotti@acm.org">Ricardo Menotti</a>
 * @author <a href="http://menotti.pro.br/">Author Page</a>  * @author <a href="http://www.dc.ufscar.br/">DC UFSCar</a>
 * @version September, 2007
 */
public class not_op extends IComponent {
	public not_op() {
		this(Parameters.getDefaultDataWidth());
	}
	public not_op(int width) {	
		super(width);
		setSync(false);
		Generic generic;
	...
	public not_op(String name) {
		this();
		super.name = name;
	}
	public not_op(String name, int width) {
		this(width);
		super.name = name;
	}
